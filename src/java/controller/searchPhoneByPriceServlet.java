 ...
 * @author ADMIN
 */
@WebServlet(name ="searchPhoneByPriceServlet", urlPatterns = {"/searchPhoneByPriceServlet"})
public class searchPhoneByPriceServlet extends HttpServlet {
    ...
    public String getServletInfo() {
        return "Search phone by price range";
    }// </editor-fold>
