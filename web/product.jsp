<%-- 
    Document   : product
    Created on : Jun 19, 2024, 12:01:04 AM
    Author     : ASUS
--%>
...
<html>
    ...
    <main class="container">
        ...
        <div class="left-column">
            <img data-image="black" src="image/<%=product.getImage()%>" alt="">
            <img data-image="blue" src="image/<%=product.getImage()%>" alt="">
            <img data-image="red" class="active" src="image/<%=product.getImage()%>" alt="">
        </div>
