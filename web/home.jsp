              ...
              <div class="swiper-wrapper">
                <div class="swiper-slide text-center d-flex justify-content-center">
                  <div class="review-item col-md-10">
                    ...
                    <blockquote>“A good service from a ministore. Amazing !! I'll back for next chance”</blockquote>
                    <div class="rating">
                ...
                <div class="swiper-slide text-center d-flex justify-content-center">
                  <div class="review-item col-md-10">
                    <i class="icon icon-review"></i>
                    <blockquote>“The product is really qualified. Every staffs are friendly and have good behaviors. ”</blockquote>
                    <div class="rating">
                      <svg class="star star-fill">
                        <use xlink:href="#star-fill"></use>
                      </svg>
