...
<html>
    ...
    <div class="row">
        <div class="col-md-2 ">
            <form class="user-option" action="MainController" method="POST">
                <div class="category">
                    ...
                    <div>
                        ...
                        <input class="brand" type="submit" name="brand" value="OPPO">  </br>

                        <input class="brand" type="submit" name="brand" value="LENOVO">  </br>
                ...
                <div>
                    ...
                    <div>
                        <input class="option-search" type="text"  name="fromPrice" placeholder="Min Price" /> </br>
                        <input class="option-search" type="text"  name="toPrice" placeholder="Max Price" />
                    </div>
                    <div>
                            ...
                            <div  class="card h-100">
                                ...
                                <div class="card-body p-4">
                                    <div class="text-center">
                                        <!-- Product name-->
                                        <h5 class="fw-bolder"> <a href="product.jsp?name=<%=product.getMobileName()%>"> <%= product.getMobileName()%></a> </h5>
                                        <!-- Product price-->
                                        <%
                                ...
                                <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                    <div class="text-center"><button class="btn btn-outline-dark mt-auto" type="submit" name="action" value="Add to cart">Add to cart </button></div>
                                </div>
                            </div>
                        </div>
                    </form>
