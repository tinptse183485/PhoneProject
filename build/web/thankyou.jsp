          ...
          <ul class="site-menu js-clone-nav d-none d-md-block">
            ...
            <li class="has-children">
              ...
              <ul class="dropdown" style="list-style-type: none;">
                    <form action="MainController" method="POST">
                        <li><a href="SearchCategoriesController?category=nam" class="d-flex">Men</a></li>
                        <li><a href="SearchCategoriesController?category=nu" class="d-flex">Women </a></li>
                        <li><a href="SearchCategoriesController?category=ram" class="d-flex">SunGlasses</a></li>
                    </form>
                </ul>
            </li>
