...
<html>
    ...
    <body>   
                                ...
                                <li class="nav-item">
                                    <div style="margin-top:1.5rem" class="user-items ps-5">
                                        <ul class="d-flex justify-content-end list-unstyled">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link me-4 active" href="addPhone.jsp">Add new items</a>
                                            </li>
        ...
        <div>                                                              <%
            ...
            %>
            <h2 style="color:#86da04;text-align: center"><%= message%></h2>
            <%
            ...
            <table border="1">
                <thead>
                    <tr>
                        ...
                        <th>img</th>
                        <th>Name</th>
                        <th style="width:2em">Description</th>
                        <th>Brand </th>
                        <th>Price</th>
                        <th>Sale</th>
                        <th>Quantity</th>
                ...
                <form action="MainController" method="post">
                    ...
                    <td>
                        <img style="width: 200px;height: 200px"src="image/<%= product.getImage()%>">
                    </td>
                    <td>
                        <input type="text" name="mobileName" value="<%= product.getMobileName()%>" required=""/>
                    </td>
                    <td>
                        <input style="height:100%" type="text" name="description" value="<%= product.getDescription()%>" required="" />
                    </td>
                    <td>
